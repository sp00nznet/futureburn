...
- ⬜ DVD menus — a proper play / chapter-select / audio-select menu instead of auto-playing the title (needs a menu VOB + button rendering)
- ⬜ Bitmap subtitles (VobSub / PGS) in the MKV→DVD pipeline — currently only text subtitles are carried over
